...
# 실시간 테스트, 주소 입력
# url = 'rtsp://183.111.96.76:8554/mask'
url = 'rtsp://1.214.48.119:5540/ch0'
# url = 'rtsp://183.111.96.111:8554/mask'
...
#while True:
while vs.isOpened() : # 비디오를 정상적으로 받아온다면(vs정상작동)
	...
	for (box, pred) in zip(locs, preds):
		...
		(zero_division, mask, withoutMask) = pred
